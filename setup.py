...
def get_extensions():
    ...
    # Ascend extension is appended before the native-extension check so an
    # NPU-only build (KERNEL_ALIGN_FORCE_ASCEND=1) never trips the CUDA/ROCm
    # "no build environment" error above.
