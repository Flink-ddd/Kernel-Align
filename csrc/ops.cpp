...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("batch_invariant_linear_logp_sm90", &batch_invariant_linear_logp_sm90_forward,
          "Batch-invariant fused linear log-prob from hidden states, single-card SM90");
