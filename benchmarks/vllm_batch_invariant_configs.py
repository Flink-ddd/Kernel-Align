...
"""Tuned configurations for vLLM's batch-invariant persistent matmul.
...
https://github.com/vllm-project/vllm/blob/7797b6022c129b862e45ae6aed08822e65d1bccb/vllm/model_executor/layers/batch_invariant_configs.py

Standalone modification: the vLLM platform abstraction and DeviceCapability
type are replaced by ``torch.cuda`` capability discovery.  The tuned table and
configuration-selection behavior are otherwise preserved from upstream.
"""
...
def _get_tuned_matmul_arch_family(
