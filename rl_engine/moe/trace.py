...
"""Minimal boundary trace for P5 (first-divergence localization).

Every operator boundary records (name, dtype, shape, sha256 of raw bytes).
This is the P5-local stand-in for the Foundation ``TraceEnvelope``.
"""
...
@dataclass
class ExpertTrace:
    """Ordered boundary hashes plus provenance notes for one P5 run."""
...
def first_divergence(a: ExpertTrace, b: ExpertTrace) -> str | None:
