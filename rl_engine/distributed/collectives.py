...
class TorchDistributedDeterministicCollective:
    ...
    def reduce_scatter_many(
        ...
        *,
        ...
        """Reduce-scatter several tensors through the single-tensor transport ABI."""
...
def create_deterministic_collective(
    ...
    *,
    ...
    reduction. The returned object has independent ownership. Shared caches may
    replace an entry without closing it immediately because active autograd
